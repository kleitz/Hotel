...
use KC\HotelBundle\Entity\Worker;
use KC\HotelBundle\Form\WorkerType;
...
class WorkerController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('KCHotelBundle:Worker')->findAll();
     ...
     *
     * @Route("/", name="admin_worker_create")
     * @Method("POST")
     * @Template("KCHotelBundle:Worker:new.html.twig")
     */
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_worker_show', array('id' => $entity->getId())));
        }
    ...
    private function createCreateForm(Worker $entity)
    {
        $form = $this->createForm(new WorkerType(), $entity, array(
            'action' => $this->generateUrl('admin_worker_create'),
            'method' => 'POST',
        ));
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('KCHotelBundle:Worker')->find($id);
    ...
    */
    ...
    {
        $form = $this->createForm(new WorkerType(), $entity, array(
            'action' => $this->generateUrl('admin_worker_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
     ...
     *
     * @Route("/{id}", name="admin_worker_update")
     * @Method("PUT")
     * @Template("KCHotelBundle:Worker:edit.html.twig")
     */
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_worker_edit', array('id' => $id)));
        }
    ...
    public function deleteAction(Request $request, $id)
    {
        ...
        return $this->redirect($this->generateUrl('admin_worker'));
    }
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_worker_delete', array('id' => $id)))
            ->setMethod('DELETE')
